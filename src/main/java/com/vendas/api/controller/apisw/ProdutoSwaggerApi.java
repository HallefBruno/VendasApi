...
public interface ProdutoSwaggerApi {
    ...
    @GetMapping("puscar-por-categoria-id-produto-id")///{produtoId}/{categoriaId}
    public ResponseEntity<?> buscarPorCategoriaIdProdutoId(@RequestParam(name = "produtoId", required = true) Long produtoId, @RequestParam(name = "categoriaId", required = true) Long categoriaId);
